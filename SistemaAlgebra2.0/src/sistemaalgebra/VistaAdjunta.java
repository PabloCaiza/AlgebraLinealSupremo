 ...
 */
public class VistaAdjunta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextFieldnNumIncognitas, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 50, 110, -1));
        ...
        getContentPane().add(jButtonGenerarMatriz, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 50, -1, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 110, 250, 180));
        ...
        jButton1.setText("Calcular Adjunta");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (bandera == true) {
            ...
            if (!Adjunta.comprobarFilas(matriz)) {
                double matriz2[][] = Adjunta.adjunta(n, matriz1);

                for (int i = 0; i < matriz2.length; i++) {
                    for (int j = 0; j < matriz2.length; j++) {

                        jTextArea.append("" + String.format("%.3f", matriz2[i][j]) + "   ");
                    }
                ...
                JOptionPane.showMessageDialog(null, "No hay adjunta");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaAdjunta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaAdjunta().setVisible(true);
            }
        });
    }
